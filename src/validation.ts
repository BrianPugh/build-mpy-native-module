...
export function validateInputs(): Config {
  ...
  // MicroPython version(s) (required) - can be comma-separated list
  ...
  const architectures = resolveArchitectures(architecture as Architecture, lowestVersion);
  ...
  return {
    ...
    architectures,
    micropythonVersion: micropythonVersionInput,
    micropythonVersions,
    micropythonRepo,
    sourceDir,
    outputName,
